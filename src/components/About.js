  ...
  return (
    <div className='about-container'>
      ...
      <div className='about-content'>
        ...
        <p>While founding my first startup (<a rel="noopener noreferrer" target='_blank' href='https://leesa.rentals'>Leesa</a>), I first got to play around with HTML, CSS and Javascript, and that was when I first got to code. </p>
        <p>I enrolled to Le Wagon's full stack developers bootcamp, and during the bootcamp (that focused on Ruby on Rails framework), I got more and more curious about other web frameworks, and fell in love with modern javascript front-end frameworks.</p>
